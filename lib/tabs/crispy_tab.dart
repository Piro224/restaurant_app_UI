...
class CrispyView extends StatelessWidget {
  ...
  List <dynamic>crispyChicken = [
    ...
    ["Fried with Fries", "40", Colors.blue, "assets/img/crispy-fried-chicken.webp"],
    ...
    ["Baked with Spices", "60", Colors.green, "assets/img/crispy-fried-chicken-plate-with-tomato-sauce.webp"],
