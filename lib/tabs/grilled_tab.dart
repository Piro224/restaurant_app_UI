...
List <dynamic>grilledChicken = [
    ...
    ["Grilled with Veges", "60", Colors.blue, "assets/img/grilled-chicken-legs-flaming-grill-with-grilled-vegetables-with-tomatoes-potatoes-pepper-seeds-salt.webp"],
    ["Grilled Wings", "55", Colors.red, "assets/img/grilled-chicken-wings-flaming-grill.webp"],
    ["Grilled Wings", "70", Colors.pink, "assets/img/grilled-chicken-wings.webp"],
    ["Baked with Spices", "65", Colors.green, "assets/img/baked-chicken-drumsticks.webp"],
